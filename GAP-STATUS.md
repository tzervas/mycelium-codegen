# Gap status — `mycelium-codegen`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-codegen` |
| **Role** | MIR + MLIR/native codegen |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-codegen-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | https://github.com/tzervas/mycelium-codegen/issues/5 , #8 |
